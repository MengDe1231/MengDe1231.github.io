...
function toggle() {
  ...
  document.body.classList.toggle('full-width-mode', isFullWidth.value)
}
</script>

<template>
  <button
    class="width-toggle-floating"
